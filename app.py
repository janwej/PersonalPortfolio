    ...
    <div id="sidebar" class="sidebar sidebar-closed fixed top-0 left-0 h-full w-64 glass-card border-r border-gray-200/50 z-50">
        <div class="p-6">
            ...
            <div class="absolute bottom-6 left-6 right-6">
                <div class="p-4 bg-blue-500/15 rounded-xl border-2 border-blue-500/30 shadow-lg">
                    <p class="text-sm text-blue-300 font-semibold mb-2">💡 Available for work</p>
        ...
        <nav class="fixed top-0 left-0 right-0 z-30 glass-card border-b-2 border-blue-500/25 shadow-sm">
            <div class="max-w-5xl mx-auto px-4 md:px-6 py-2 md:py-4">
                <div class="flex items-center justify-between">
                    ...
                    <button id="back-home-btn" onclick="showPage('home')" class="hidden items-center gap-2 px-4 md:px-5 py-2 bg-white/50 rounded-full text-sm font-medium hover:bg-slate-700/50 transition-colors">
                    ...
                    <section id="skills" class="pb-20">
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="glass-card rounded-3xl p-6 border-2 border-blue-500/15 shadow-sm card-hover">
                                ...
                                <div class="glass-card rounded-3xl p-6 border-2 border-blue-500/15 shadow-sm card-hover">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <span class="px-3 py-1.5 bg-slate-700/50 rounded-full text-sm text-gray-300">RStudio</span>
                                        <span class="px-3 py-1.5 bg-slate-700/50 rounded-full text-sm text-gray-300">SQL development environments</span>
                                    </div>
                                </div>
                                ...
                                <div class="glass-card rounded-3xl p-6 border-2 border-blue-500/15 shadow-sm card-hover">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1.5 bg-slate-700/50 rounded-full text-sm text-gray-300">Relational databases (DB2, MySQL)</span>
                                        <span class="px-3 py-1.5 bg-slate-700/50 rounded-full text-sm text-gray-300">MongoDB</span>
                                        <span class="px-3 py-1.5 bg-slate-700/50 rounded-full text-sm text-gray-300">HDFS & object storage (S3)</span>
                                        <span class="px-3 py-1.5 bg-slate-700/50 rounded-full text-sm text-gray-300">Data lakes</span>
                                    </div>
                                </div>
                                ...
                                <div class="glass-card rounded-3xl p-6 border-2 border-blue-500/15 shadow-sm card-hover">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1.5 bg-slate-700/50 rounded-full text-sm text-gray-300">Data cleaning & preparation</span>
                    ...
                    <section id="contact" class="pb-20">
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <a href="mailto:jan.wejchert@student.ie.edu" class="glass-card rounded-3xl p-6 border-2 border-blue-500/15 shadow-sm card-hover block">
                                ...
                                <a href="https://github.com/janwej" target="_blank" class="glass-card rounded-3xl p-6 border-2 border-blue-500/15 shadow-sm card-hover block">
                                    <div class="flex items-center gap-4 mb-3">
                                        <div class="w-12 h-12 bg-purple-500/10 rounded-2xl flex items-center justify-center">
                                ...
                                <a href="https://linkedin.com/in/jan-wejchert" target="_blank" class="glass-card rounded-3xl p-6 border-2 border-blue-500/15 shadow-sm card-hover block">
                                    <div class="flex items-center gap-4 mb-3">
                                        <div class="w-12 h-12 bg-green-500/10 rounded-2xl flex items-center justify-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        <div class="glass-card rounded-3xl overflow-hidden border-2 border-blue-500/15 shadow-sm card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <p class="text-gray-400 mb-4">Comprehensive analysis of Formula 1 historical race data to identify drivers with exceptional position-gaining performance. Utilized Python and Pandas to process race results, implement scoring algorithms, and conduct decade-based comparative analysis.</p>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Data Analysis</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Python</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Pandas</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Statistical Analysis</span>
                                </div>
                                <button onclick="showPage('f1-project')" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors mt-auto shadow-md hover:shadow-lg">View Project</button>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border-2 border-blue-500/15 shadow-sm card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Python</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Time Series Analysis</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Forecasting</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Data Visualization</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Model Evaluation</span>
                                </div>
                                <button onclick="showPage('timeseries-project')" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors mt-auto shadow-md hover:shadow-lg">View Details</button>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border-2 border-blue-500/15 shadow-sm card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Apache NiFi</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">MinIO (S3)</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Apache Spark</span>
                                </div>
                                <button onclick="showPage('earthquake-pipeline-project')" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors mt-auto shadow-md hover:shadow-lg">View Details</button>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border-2 border-blue-500/15 shadow-sm card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Mathematica</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Shooting Algorithm</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Genetic Algorithm</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Economic Modeling</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Numerical Optimization</span>
                                </div>
                                <button onclick="showPage('growth-model-project')" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors mt-auto shadow-md hover:shadow-lg">View Details</button>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border-2 border-blue-500/15 shadow-sm card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Mathematica</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Dynamic Programming</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Bellman Iteration</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Graph Optimization</span>
                                    <span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">Shortest Path</span>
                                </div>
                                <button onclick="showPage('graph-optimization-project')" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors mt-auto shadow-md hover:shadow-lg">View Details</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col md:flex-row items-start justify-between gap-4 mb-6">
                            ...
                            <a href="/The-Comeback-King-F1s-Greatest-Position-Gainer.pdf" download class="px-6 py-3 bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg rounded-xl font-medium transition-colors flex items-center gap-2 w-full md:w-auto justify-center">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                        ...
                        <!-- Project Overview -->
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                                <div class="bg-slate-700/50/30 rounded-xl p-4">
                        ...
                        <!-- Code Section -->
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-300">f1new = f1.groupby("driver")[["grid_starting_position"]].count().reset_index()
...
f1_filtered = f1[f1["driver"].isin(f1_group)]</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-300">race_finishers = f1_filtered[~f1_filtered["final_position"].isna()].copy()
...
race_finishers = race_finishers[(race_finishers["year"] >= 1960) & (race_finishers["year"] < 1970)]</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-300">from collections import defaultdict
...
rank_to_points = {1: 3, 2: 2, 3: 1}</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-300">def add_points_from_series(ser, points_dict):
    current_rank = 0
    ...
    for driver, value in ser.items():
        ...
        points_dict[driver] += rank_to_points[current_rank]</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-300"># Category 1: Average positions gained per race
...
add_points_from_series(s6, driver_points)</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-300">champion = dict(driver_points)
print(champion)
...
print(keys_with_max_value)</code></pre>
                        ...
                        <!-- Results -->
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mt-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        <div class="bg-slate-700/50/30 rounded-lg p-3">
                    ...
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col md:flex-row items-start justify-between gap-4 mb-6">
                            ...
                            <div class="flex flex-col gap-3 flex-shrink-0 w-full md:w-auto">
                                <a href="/Project1_Final.ipynb" download class="px-6 py-3 bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg rounded-xl font-medium transition-colors flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Download Notebook
                                </a>
                                <a href="/co2.json" download class="px-6 py-3 bg-slate-700/50 hover:bg-slate-600/50/50 rounded-xl font-medium transition-colors flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Download Data
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Python</span>
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Pandas</span>
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Time Series Analysis Libraries</span>
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Data Visualization</span>
                            </div>
                        </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col md:flex-row items-start justify-between gap-4 mb-6">
                            ...
                            <div class="flex-shrink-0 w-full md:w-auto">
                                <a href="/EC3307Graph.nb" download class="px-6 py-3 bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg rounded-xl font-medium transition-colors flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Download Notebook
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="mt-6 bg-slate-700/50/30 rounded-xl p-5">
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div class="bg-slate-700/50/30 rounded-xl p-4 mb-4">
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="bg-slate-700/50/30 rounded-xl p-5">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <span class="px-3 py-1 bg-slate-600/50/50 rounded-full text-xs text-gray-300">Routing problems (transport, logistics)</span>
                                    <span class="px-3 py-1 bg-slate-600/50/50 rounded-full text-xs text-gray-300">Network optimization</span>
                                    <span class="px-3 py-1 bg-slate-600/50/50 rounded-full text-xs text-gray-300">Planning and decision-making under costs</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Mathematica</span>
                                    </div>
                                </div>
                                <div>
                                    <h3 class="text-lg font-semibold text-pink-400 mb-3">Skills</h3>
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Dynamic Programming</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Bellman Iteration</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Graph Optimization</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Shortest Path</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Data Parsing</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Algorithmic Implementation</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col md:flex-row items-start justify-between gap-4 mb-6">
                            ...
                            <div class="flex-shrink-0 w-full md:w-auto">
                                <a href="/EC3307Algorithms.nb" download class="px-6 py-3 bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg rounded-xl font-medium transition-colors flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Download Notebook
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Shooting Algorithm</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Genetic Algorithm</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Economic Modeling</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Numerical Optimization</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Dynamic Programming</span>
                                        <span class="px-3 py-1 bg-slate-700/50 rounded-full text-sm text-gray-300">Computational Economics</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col md:flex-row items-start justify-between gap-4 mb-6">
                            ...
                            <div class="flex flex-col gap-3 flex-shrink-0 w-full md:w-auto">
                                <a href="/earthquake-json-flow.json" download class="px-6 py-3 bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg rounded-xl font-medium transition-colors flex items-center gap-2 justify-center">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Download JSON Flow
                                </a>
                                <a href="/earthquake-csv-flow.json" download class="px-6 py-3 bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg rounded-xl font-medium transition-colors flex items-center gap-2 justify-center">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Download CSV Flow
                                </a>
                                <a href="/Project.ipynb" download class="px-6 py-3 bg-slate-700/50 hover:bg-slate-600/50/50 rounded-xl font-medium transition-colors flex items-center gap-2 justify-center">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="bg-slate-700/50/30 rounded-xl p-5 mt-6">
                                <h3 class="text-lg font-semibold text-blue-400 mb-3">Pipeline Structure</h3>
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="mb-6">
                                <h3 class="text-xl font-bold mb-4 text-blue-400">Two NiFi Flows</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div class="bg-slate-700/50/30 rounded-xl p-5">
                                        <h4 class="text-lg font-semibold text-blue-400 mb-2">JSON Flow</h4>
                                        <p class="text-gray-300 text-sm">Ingests earthquake data in JSON format</p>
                                    </div>
                                    <div class="bg-slate-700/50/30 rounded-xl p-5">
                                        <h4 class="text-lg font-semibold text-blue-400 mb-2">CSV Flow</h4>
                                        <p class="text-gray-300 text-sm">Ingests earthquake data in CSV format</p>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-slate-700/50/30 rounded-xl p-5">
                                <h4 class="text-sm font-semibold text-blue-400 mb-3">Flow Capabilities:</h4>
                                <ul class="text-sm text-gray-300 space-y-2">
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="bg-slate-700/50/30 rounded-xl p-5">
                                <h3 class="text-lg font-semibold text-blue-400 mb-3">Decoupled Architecture</h3>
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="bg-slate-700/50/30 rounded-xl p-5 mb-4">
                                <h3 class="text-lg font-semibold text-blue-400 mb-3">Notebook Workflow:</h3>
                                <ul class="text-sm text-gray-300 space-y-2">
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            ...
                            <div class="space-y-4">
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">Earthquake Activity is Highly Skewed</h3>
                                ...
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">Clear Temporal Patterns Emerge</h3>
                                ...
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">Geographical Concentration of Events</h3>
                                ...
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">Magnitude vs Frequency Trade-off</h3>
                                ...
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">Scalability of Analysis</h3>
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm mb-8">
                            <h2 class="text-2xl sm:text-3xl font-bold mb-6">Tools & Technologies</h2>
                            <div class="flex flex-wrap gap-3">
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Apache NiFi</span>
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">MinIO (S3)</span>
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Apache Spark</span>
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Spark DataFrames</span>
                                <span class="px-4 py-2 bg-slate-700/50 rounded-full text-sm text-gray-300">Spark SQL</span>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border-2 border-blue-500/15 shadow-sm">
                            ...
                            <div class="space-y-4">
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">NiFi Flow for JSON Data Ingestion</h3>
                                    <p class="text-gray-300 text-sm">Import this flow file into NiFi to recreate the JSON ingestion pipeline</p>
                                </div>
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">NiFi Flow for CSV Data Ingestion</h3>
                                    <p class="text-gray-300 text-sm">Import this flow file into NiFi to recreate the CSV ingestion pipeline</p>
                                </div>
                                <div class="bg-slate-700/50/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-blue-400 mb-2">Spark Notebook</h3>
    ...
    <script>
        ...
        function loadAcademicWorksList() {
            ...
            academicWorks.forEach(work => {
                ...
                workCard.className = 'glass-card rounded-3xl overflow-hidden border-2 border-blue-500/15 shadow-sm card-hover flex flex-col h-full';
                workCard.innerHTML = `
                    <div class="p-4 md:p-6 flex flex-col h-full">
                        <div class="mb-3">
                            <div class="inline-block px-3 py-1 bg-blue-500/10 text-blue-400 rounded-full text-xs font-medium mb-3">
                        ...
                        <div class="flex flex-wrap gap-2 mb-4">
                            ${work.tags ? work.tags.map(tag => `<span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">${tag}</span>`).join('') : ''}
                            ${work.year ? `<span class="px-3 py-1 bg-slate-700/50 rounded-full text-xs text-gray-300">${work.year}</span>` : ''}
                        </div>
                        <button onclick="showAcademicWork('${work.id}')" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors font-medium mt-auto shadow-md hover:shadow-lg">View Work</button>
                    </div>
                `;
        ...
        function showAcademicWork(workId) {
            ...
            if (work.pdfPath) {
                ...
                downloadBtn.className = 'px-6 py-3 bg-blue-600 hover:bg-blue-700 shadow-md hover:shadow-lg rounded-xl font-medium transition-colors flex items-center gap-2';

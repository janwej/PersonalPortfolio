...
<body class="text-gray-900">
    ...
    <!-- Sidebar -->
    <div id="sidebar" class="sidebar sidebar-closed fixed top-0 left-0 h-full w-64 glass-card border-r border-gray-200/50 z-50">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <button onclick="showPage('projects')" class="menu-item w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-gray-600" data-page="projects">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button onclick="showPage('academic-works')" class="menu-item w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-gray-600" data-page="academic-works">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button onclick="showPage('experience')" class="menu-item w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-gray-600" data-page="experience">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button onclick="showPage('resume')" class="menu-item w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-gray-600" data-page="resume">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <nav class="fixed top-0 left-0 right-0 z-30 glass-card border-b border-gray-200/50">
            <div class="max-w-5xl mx-auto px-4 md:px-6 py-2 md:py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div id="home-nav" class="hidden md:flex items-center gap-2 bg-white/50 rounded-full p-1.5">
                        <button onclick="scrollToSection('about')" class="nav-pill active px-5 py-2 rounded-full text-sm font-medium">
                            About
                        </button>
                        <button onclick="scrollToSection('skills')" class="nav-pill px-5 py-2 rounded-full text-sm font-medium text-gray-600">
                            Skills
                        </button>
                        <button onclick="scrollToSection('education')" class="nav-pill px-5 py-2 rounded-full text-sm font-medium text-gray-600">
                            Education
                        </button>
                        <button onclick="scrollToSection('contact')" class="nav-pill px-5 py-2 rounded-full text-sm font-medium text-gray-600">
                            Contact
                        </button>
                    </div>
                    <button id="back-home-btn" onclick="showPage('home')" class="hidden items-center gap-2 px-4 md:px-5 py-2 bg-white/50 rounded-full text-sm font-medium hover:bg-gray-100 transition-colors">
            ...
            <div class="pt-28 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
                <div class="max-w-5xl mx-auto space-y-12">
                    ...
                    <section id="about" class="pb-20">
                        <div class="space-y-8">
                            <div>
                                <div class="inline-block px-4 py-1.5 bg-gray-100 rounded-full text-sm font-medium text-gray-700 mb-6">
                                    Welcome 👋
                                </div>
                                <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                                    <span class="text-gray-900">Jan Jacek</span> <span class="text-gray-700">Wejchert</span>
                                </h1>
                                ...
                                <div class="flex flex-wrap items-center gap-4 md:gap-6 text-base md:text-lg text-gray-600">
                    ...
                    <section id="skills" class="pb-20">
                        <div class="space-y-8">
                            <div>
                                ...
                                <p class="text-gray-600 text-lg">Technologies and tools I work with</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="glass-card rounded-3xl p-6 border border-gray-200/50 card-hover">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Python</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">SQL</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">R (RStudio</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Stata</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Mathematica</span>
                                    </div>
                                </div>
                                ...
                                <div class="glass-card rounded-3xl p-6 border border-gray-200/50 card-hover">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Jupyter Notebokk</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">PyCharm</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">GitHub</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">VS Code</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">RStudio</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">SQL development environments</span>
                                    </div>
                                </div>
                                ...
                                <div class="glass-card rounded-3xl p-6 border border-gray-200/50 card-hover">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Relational databases (DB2, MySQL)</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">MongoDB</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">HDFS & object storage (S3)</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Data lakes</span>
                                    </div>
                                </div>
                                ...
                                <div class="glass-card rounded-3xl p-6 border border-gray-200/50 card-hover">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Data cleaning & preparation</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Exploratory data analysis</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Time series analysis</span>
                                        <span class="px-3 py-1.5 bg-gray-100 rounded-full text-sm text-gray-700">Forecasting</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="education" class="pb-20">
                        <div class="space-y-8">
                            <div>
                                ...
                                <p class="text-gray-600 text-lg">My academic background</p>
                            </div>
                                    ...
                                    <div class="flex items-start justify-between flex-wrap gap-4">
                                        <div class="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-700 mb-2">IE School of Science and Technology, Madrid, Spain</p>
                                                <p class="text-sm text-gray-600">Running GPA: 3,92 out of 4</p>
                                            </div>
                                        </div>
                                        <div class="px-4 py-2 bg-gray-100 rounded-xl text-sm text-gray-700">
                                            2025 - 2026
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-start justify-between flex-wrap gap-4">
                                        <div class="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-700 mb-2">University of St Andrews, St Andrews, Scotland</p>
                                                <p class="text-sm text-gray-600">Graduated with Honours of the Second Class (Division l)</p>
                                            </div>
                                        </div>
                                        <div class="px-4 py-2 bg-gray-100 rounded-xl text-sm text-gray-700">
                                            2021 - 2025
                                    ...
                                    <div class="flex items-start justify-between flex-wrap gap-4">
                                        <div class="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-700 mb-2">Akademeia High School, Warsaw, Poland</p>
                                                <p class="text-sm text-gray-600">Economics, Mathematics, Further Mathematics, Polish (A*, A*, A*, A)</p>
                                            </div>
                                        </div>
                                        <div class="px-4 py-2 bg-gray-100 rounded-xl text-sm text-gray-700">
                                            2019 - 2021
                    ...
                    <section id="contact" class="pb-20">
                        <div class="space-y-8">
                            <div>
                                ...
                                <p class="text-gray-600 text-lg">Let's connect and create something amazing together</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <a href="https://linkedin.com/in/jan-wejchert" target="_blank" class="glass-card rounded-3xl p-6 border border-gray-200/50 card-hover block">
                                    ...
                                    <p class="text-gray-700">linkedin.com/in/jan-wejchert</p>
                                </a>
                            </div>
                        </div>
                    </section>
            ...
            <div class="pt-28 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
                <div class="max-w-5xl mx-auto">
                    <div class="mb-12">
                        ...
                        <p class="text-gray-600 text-lg">A showcase of my recent work and side projects</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        <div class="glass-card rounded-3xl overflow-hidden border border-gray-200/50 card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <h3 class="text-2xl font-bold mb-2">F1 Data Analysis Project</h3>
                                <p class="text-gray-600 mb-4">Comprehensive analysis of Formula 1 historical race data to identify drivers with exceptional position-gaining performance. Utilized Python and Pandas to process race results, implement scoring algorithms, and conduct decade-based comparative analysis.</p>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Data Analysis</span>
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Python</span>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border border-gray-200/50 card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <p class="text-gray-600 mb-4">Applied time series analysis using real-world data to explore trends, seasonality, and forecasting performance. Implemented and evaluated classical forecasting methods including moving averages and exponential smoothing.</p>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Python</span>
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Time Series Analysis</span>
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Forecasting</span>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border border-gray-200/50 card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <p class="text-gray-600 mb-4">End-to-end data pipeline that ingests live earthquake data, stores it in object storage, and analyzes it using Apache Spark. Demonstrates realistic data workflows and scalable analytics.</p>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Apache NiFi</span>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border border-gray-200/50 card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <p class="text-gray-600 mb-4">Solves a deterministic neoclassical growth model using two numerical approaches: shooting algorithm and genetic algorithm. Compares convergence, stability, and behavior of classical optimization methods versus evolutionary algorithms.</p>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Mathematica</span>
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Shooting Algorithm</span>
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Genetic Algorithm</span>
                        ...
                        <div class="glass-card rounded-3xl overflow-hidden border border-gray-200/50 card-hover flex flex-col">
                            ...
                            <div class="p-4 md:p-6 flex flex-col h-full">
                                ...
                                <p class="text-gray-600 mb-4">Complete shortest-path solver in Mathematica using dynamic programming and Bellman iteration. Constructs distance matrices, computes optimal cost-to-go functions, and recovers optimal paths with minimum total cost.</p>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Mathematica</span>
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Dynamic Programming</span>
                                    <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Bellman Iteration</span>
            ...
            <div class="pt-28 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
                <div class="max-w-5xl mx-auto">
                    <div class="mb-12">
                        ...
                        <p class="text-gray-600 text-lg">My professional journey</p>
                    </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 card-hover">
                            <div class="flex items-start justify-between flex-wrap gap-4 mb-4">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Intern at Brevan Howard, gaining hands-on exposure to global macro trading, portfolio construction, and risk frameworks while supporting portfolio managers with analytical tools and proprietary financial modeling.</p>
                                </div>
                                <div class="px-4 py-2 bg-gray-100 rounded-xl text-sm text-gray-700">
                                    2024 Summer
                                </div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">London</span>
                                <span class="px-3 py-1 bg-gray-100 rounded-full text-xs text-gray-700">Abu Dhabi</span>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 card-hover">
                            <div class="flex items-start justify-between flex-wrap gap-4 mb-4">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Intern at Passion Capital, contributing to early-stage venture capital sourcing and due diligence through startup analysis, founder meetings, and investment research across AI and fintech.</p>
                                </div>
                                <div class="px-4 py-2 bg-gray-100 rounded-xl text-sm text-gray-700">
                                    2023 Summer
                                </div>
                    ...
                    <div class="glass-card rounded-3xl p-12 border border-gray-200/50">
                        <div class="space-y-8">
                            <div class="text-center">
                                ...
                                <p class="text-xl text-gray-700 mb-4">MSc Business Analytics & Data Science Student</p>
                                <div class="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-600">
                                    <a href="mailto:jan.wejchert@student.ie.edu" class="flex items-center gap-2 hover:text-gray-700 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                        </svg>
                                    ...
                                    <a href="https://github.com/janwej" target="_blank" class="flex items-center gap-2 hover:text-gray-700 transition-colors">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                                        </svg>
                                        <span>github.com/janwej</span>
                                    </a>
                                    <a href="https://linkedin.com/in/jan-wejchert" target="_blank" class="flex items-center gap-2 hover:text-gray-700 transition-colors">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                                        </svg>
                                        <span>LinkedIn</span>
                                ...
                                <div class="space-y-6">
                                    <div>
                                        <div class="flex items-start justify-between flex-wrap gap-4 mb-2">
                                            <div>
                                                <h4 class="text-lg font-semibold text-gray-800">Master of Science in Business Analytics and Data Science</h4>
                                                <p class="text-gray-600">IE School of Science and Technology, Madrid, Spain</p>
                                            </div>
                                            <span class="text-sm text-gray-600">2025 - 2026</span>
                                        </div>
                                        <p class="text-sm text-gray-600">Running GPA: 3.92 out of 4</p>
                                    </div>
                                    ...
                                    <div>
                                        <div class="flex items-start justify-between flex-wrap gap-4 mb-2">
                                            <div>
                                                <h4 class="text-lg font-semibold text-gray-800">Bachelor of Science in Economics</h4>
                                                <p class="text-gray-600">University of St Andrews, St Andrews, Scotland</p>
                                            </div>
                                            <span class="text-sm text-gray-600">2021 - 2025</span>
                                        </div>
                                        <p class="text-sm text-gray-600">Graduated with Honours of the Second Class (Division I)</p>
                                    </div>
                                    
                                    <div>
                                        <div class="flex items-start justify-between flex-wrap gap-4 mb-2">
                                            <div>
                                                <h4 class="text-lg font-semibold text-gray-800">International A Levels</h4>
                                                <p class="text-gray-600">Akademeia High School, Warsaw, Poland</p>
                                            </div>
                            ...
                            <div class="border-t border-gray-200 pt-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <h4 class="font-semibold text-gray-700 mb-3">Programming & Analytical Languages</h4>
                                        <p class="text-gray-600 text-sm">Python, SQL, R (RStudio), Stata, Mathematica</p>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-700 mb-3">Tools & Environments</h4>
                                        <p class="text-gray-600 text-sm">Jupyter Notebook, PyCharm, GitHub, VS Code, RStudio, SQL development environments</p>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-700 mb-3">Databases & Storage</h4>
                                        <p class="text-gray-600 text-sm">Relational databases (DB2, MySQL), MongoDB, HDFS & object storage (S3), Data lakes</p>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-700 mb-3">Data Analysis & Modeling</h4>
                                        <p class="text-gray-600 text-sm">Data cleaning & preparation, Exploratory data analysis, Time series analysis, Forecasting</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="pt-28 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
                <div class="max-w-5xl mx-auto">
                    <div class="mb-12">
                        ...
                        <p class="text-gray-600 text-lg">A collection of my academic papers, research, and scholarly contributions</p>
                    </div>
        ...
        <div id="page-academic-work" class="page-content">
            <div class="pt-28 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
                <div class="max-w-6xl mx-auto">
                    <div class="mb-12">
                        <div class="mb-6">
                            <button onclick="showPage('academic-works')" class="mb-6 flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                                </svg>
                        ...
                        <div class="flex items-start justify-between flex-wrap gap-4 mb-6">
                            <div class="flex-1 min-w-0">
                                ...
                                <p id="academic-work-subtitle" class="text-gray-600 text-lg">Work subtitle and description</p>
                            </div>
        ...
        <div id="page-f1-project" class="page-content">
            <div class="pt-28 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
                <div class="max-w-6xl mx-auto">
                    <div class="mb-12">
                        <div class="mb-6">
                            <button onclick="showPage('projects')" class="mb-6 flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                                </svg>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                                <div class="bg-gray-100/30 rounded-xl p-4">
                                    ...
                                    <div class="text-gray-700">Python</div>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-4">
                                    <div class="text-violet-400 font-bold mb-1">Tools</div>
                                    <div class="text-gray-700">Pandas, Jupyter Notebook</div>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-4">
                                    <div class="text-violet-400 font-bold mb-1">Winner</div>
                                    <div class="text-gray-700">Sebastian Vettel</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="space-y-3 mb-6">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-800">Average positions gained per race</span>
                                        <span class="text-gray-600"> - includes dropped positions</span>
                                    </div>
                                </div>
                                <div class="flex gap-3">
                                    <span class="text-violet-400 font-bold">2.</span>
                                    <div>
                                        <span class="font-semibold text-gray-800">Total positions gained in all races</span>
                                        <span class="text-gray-600"> - includes dropped positions</span>
                                    </div>
                                </div>
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-800">Record positions gained within one race</span>
                                    </div>
                                </div>
                                <div class="flex gap-3">
                                    <span class="text-violet-400 font-bold">4.</span>
                                    <div>
                                        <span class="font-semibold text-gray-800">Circuits with highest average positions gained</span>
                                    </div>
                                </div>
                                <div class="flex gap-3">
                                    <span class="text-violet-400 font-bold">5.</span>
                                    <div>
                                        <span class="font-semibold text-gray-800">Circuit records for most positions gained</span>
                                    </div>
                                </div>
                                <div class="flex gap-3">
                                    <span class="text-violet-400 font-bold">6.</span>
                                    <div>
                                        <span class="font-semibold text-gray-800">Comeback Rate</span>
                                        <span class="text-gray-600"> - percentage of races with positive position gain</span>
                                    </div>
                                </div>
                            </div>

                            <h3 class="text-xl font-bold mb-3 text-violet-400">Scoring System:</h3>
                            <p class="text-gray-700 mb-2">In each category, points were awarded to top 3 drivers:</p>
                            ...
                            <p class="text-gray-700">Drivers were grouped by decade (1950s-2020s), with decade winners advancing through knockout rounds until a final champion was crowned.</p>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-700">f1new = f1.groupby("driver")[["grid_starting_position"]].count().reset_index()
...
f1_filtered = f1[f1["driver"].isin(f1_group)]</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-700">race_finishers = f1_filtered[~f1_filtered["final_position"].isna()].copy()
...
race_finishers = race_finishers[(race_finishers["year"] >= 1960) & (race_finishers["year"] < 1970)]</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-700">from collections import defaultdict
...
rank_to_points = {1: 3, 2: 2, 3: 1}</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-700">def add_points_from_series(ser, points_dict):
    current_rank = 0
    ...
    for driver, value in ser.items():
        ...
        points_dict[driver] += rank_to_points[current_rank]</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-700"># Category 1: Average positions gained per race
...
add_points_from_series(s6, driver_points)</code></pre>
                                ...
                                <div>
                                    ...
                                    <pre class="bg-white/40 rounded-xl p-4 overflow-x-auto"><code class="text-sm text-gray-700">champion = dict(driver_points)
print(champion)
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">1950s</div>
                                            <div class="font-bold">Johnny Claes</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">1960s</div>
                                            <div class="font-bold">Carel Godin de Beaufort</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">1970s</div>
                                            <div class="font-bold">Hector Rebaque</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">1980s</div>
                                            <div class="font-bold">Marc Surer</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">1990s</div>
                                            <div class="font-bold">Alex Caffi</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">2000s</div>
                                            <div class="font-bold">Tarso Marques</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">2010s</div>
                                            <div class="font-bold">Sebastian Vettel</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-lg p-3">
                                            <div class="text-gray-600 text-sm">2020s</div>
                                ...
                                <div>
                                    ...
                                    <div class="bg-gradient-to-r from-violet-500/20 to-purple-500/20 border-2 border-violet-500/50 rounded-xl p-6 text-center">
                                        ...
                                        <div class="text-gray-700 text-lg">The Comeback King</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col md:flex-row items-start justify-between gap-4 mb-6">
                            ...
                            <div class="flex flex-col gap-3 flex-shrink-0 w-full md:w-auto">
                                ...
                                <a href="/co2.json" download class="px-6 py-3 bg-gray-100 hover:bg-gray-200/50 rounded-xl font-medium transition-colors flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Download Data
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Exploratory Analysis</h3>
                                        <p class="text-gray-600">Visualization of long-term trends and seasonal behavior</p>
                                    </div>
                                </div>
                                <div class="flex gap-4">
                                    <div class="w-8 h-8 bg-cyan-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Time Series Decomposition</h3>
                                        <p class="text-gray-600">Breaking down the series into trend, seasonal, and residual components</p>
                                    </div>
                                </div>
                                <div class="flex gap-4">
                                    <div class="w-8 h-8 bg-cyan-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Baseline Smoothing Methods</h3>
                                        <p class="text-gray-600">Implementation of smoothing techniques to reduce noise and capture underlying dynamics</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    ...
                                    <p class="text-gray-700 text-sm">To smooth short-term volatility and identify underlying patterns</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-cyan-400 mb-2">Exponential Smoothing</h3>
                                    <p class="text-gray-700 text-sm">To assign greater weight to recent observations for more responsive forecasts</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-cyan-400 mb-2">Parameter Comparison</h3>
                                    <p class="text-gray-700 text-sm">Comparison of forecasts across different smoothing parameters</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-cyan-400 mb-2">Out-of-Sample Evaluation</h3>
                                    <p class="text-gray-700 text-sm">Using train/test splits to assess predictive accuracy</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    ...
                                    <p class="text-gray-700">The CO₂ series exhibits a strong, persistent upward trend alongside clear seasonal cycles</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-cyan-400 mb-2">Moving Averages Performance</h3>
                                    <p class="text-gray-700">Moving averages effectively smooth noise but lag during periods of rapid change</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-cyan-400 mb-2">Exponential Smoothing Advantages</h3>
                                    <p class="text-gray-700">Exponential smoothing provides more responsive forecasts and better short-term performance</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-cyan-400 mb-2">Trade-off Analysis</h3>
                                    <p class="text-gray-700">Model choice involves a clear trade-off between stability and adaptability</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700">Pandas</span>
                                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700">Time Series Analysis Libraries</span>
                                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700">Data Visualization</span>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-gray-700">Time series structuring and indexing</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <svg class="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Trend and seasonality analysis</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <svg class="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Forecasting and model evaluation</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <svg class="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Analytical interpretation of temporal data</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="mb-12">
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="mt-6 bg-gray-100/30 rounded-xl p-5">
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div class="bg-gray-100/30 rounded-xl p-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <div class="bg-gray-100/30 rounded-xl p-4">
                                            ...
                                            <div class="text-gray-700">500</div>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-xl p-4">
                                            <div class="text-pink-400 font-bold mb-1">Tolerance</div>
                                            <div class="text-gray-700">10<sup>-6</sup></div>
                                        </div>
                                    </div>
                                    <p class="text-gray-700 leading-relaxed">
                            ...
                            <div class="bg-gradient-to-r from-pink-500/10 to-rose-500/10 border border-pink-500/20 rounded-xl p-6">
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <span class="text-gray-700 ml-2 font-mono">{17, 23, 33, 41, 53, 56, 57, 60, 67, 70, 73, 76, 85, 89, 99}</span>
                                    </div>
                                    <div>
                                        <span class="text-pink-400 font-semibold">Minimum Cost:</span>
                                        <span class="text-gray-700 ml-2 font-mono">194.22</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div class="flex items-start gap-3">
                                    ...
                                    <span class="text-gray-700">Translate algorithmic theory into working code</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-pink-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Implement dynamic programming and iterative optimization methods</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-pink-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Handle real input parsing and edge cases (missing connections, indexing, Infinity handling)</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-pink-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Build an end-to-end solution that outputs interpretable results</span>
                                </div>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-5">
                                <h3 class="text-lg font-semibold text-pink-400 mb-3">Real-World Applications</h3>
                                <div class="flex flex-wrap gap-2">
                                    <span class="px-3 py-1 bg-gray-200/50 rounded-full text-xs text-gray-700">Routing problems (transport, logistics)</span>
                                    <span class="px-3 py-1 bg-gray-200/50 rounded-full text-xs text-gray-700">Network optimization</span>
                                    <span class="px-3 py-1 bg-gray-200/50 rounded-full text-xs text-gray-700">Planning and decision-making under costs</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Mathematica</span>
                                    </div>
                                </div>
                                <div>
                                    <h3 class="text-lg font-semibold text-pink-400 mb-3">Skills</h3>
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Dynamic Programming</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Bellman Iteration</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Graph Optimization</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Shortest Path</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Data Parsing</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Algorithmic Implementation</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    ...
                                    <p class="text-gray-700 text-sm">Import graph & build distance matrix <em>Q</em></p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-pink-400 mb-2">bellmanIteration[Q, Jn]</h3>
                                    <p class="text-gray-700 text-sm">Compute Bellman update <em>J<sub>n+1</sub></em></p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-pink-400 mb-2">findCostToGo[Q, maxIter, tol]</h3>
                                    <p class="text-gray-700 text-sm">Iterate until convergence to final <em>J</em></p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-pink-400 mb-2">findPathAndTotalCost[Q, J, startNode]</h3>
                                    <p class="text-gray-700 text-sm">Recover optimal path + total cost</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="mb-12">
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div class="bg-gray-100/30 rounded-xl p-4">
                                    ...
                                    <div class="text-gray-700">70</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="space-y-3">
                                <div class="flex gap-3">
                                    ...
                                    <p class="text-gray-700">Fully defines the competitive equilibrium</p>
                                </div>
                                <div class="flex gap-3">
                                    <svg class="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <p class="text-gray-700">Derives the first-order conditions for households and firms</p>
                                </div>
                                <div class="flex gap-3">
                                    <svg class="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <p class="text-gray-700">Obtains the Euler equation governing optimal consumption and capital accumulation</p>
                                </div>
                                <div class="flex gap-3">
                                    <svg class="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <p class="text-gray-700">Solves analytically for the steady-state capital stock <em>K*</em></p>
                                </div>
                            </div>
                            <p class="text-gray-700 leading-relaxed mt-4">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="bg-gray-100/30 rounded-xl p-4">
                                        ...
                                        <div class="text-gray-700 text-sm">Retains the top 50% of solutions by fitness</div>
                                    </div>
                                    <div class="bg-gray-100/30 rounded-xl p-4">
                                        <div class="text-emerald-400 font-bold mb-2">Parent Selection</div>
                                        <div class="text-gray-700 text-sm">Probabilistic selection weighted by fitness</div>
                                    </div>
                                    <div class="bg-gray-100/30 rounded-xl p-4">
                                        <div class="text-emerald-400 font-bold mb-2">Crossover</div>
                                        <div class="text-gray-700 text-sm">Binary encoding with random crossover points</div>
                                    </div>
                                    <div class="bg-gray-100/30 rounded-xl p-4">
                                        <div class="text-emerald-400 font-bold mb-2">Mutation</div>
                                        <div class="text-gray-700 text-sm">Bit-flipping with a 2.5% mutation rate</div>
                                    </div>
                                    <div class="bg-gray-100/30 rounded-xl p-4">
                                        <div class="text-emerald-400 font-bold mb-2">Population Size</div>
                                        <div class="text-gray-700 text-sm">80</div>
                                    </div>
                                    <div class="bg-gray-100/30 rounded-xl p-4">
                                        <div class="text-emerald-400 font-bold mb-2">Generations</div>
                                        <div class="text-gray-700 text-sm">1000+</div>
                                    </div>
                                </div>
                                <p class="text-gray-700 leading-relaxed mt-4">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="bg-gray-100/30 rounded-xl p-5">
                                            ...
                                            <p class="text-gray-700 text-sm">Produces a smooth, declining savings rate consistent with optimal intertemporal behavior</p>
                                        </div>
                                        <div class="bg-gray-100/30 rounded-xl p-5">
                                            <h4 class="text-lg font-semibold text-emerald-400 mb-2">Genetic Algorithm</h4>
                                            <p class="text-gray-700 text-sm">Produces a highly volatile savings rate, though its average level aligns broadly with the shooting solution</p>
                                        </div>
                                    </div>
                                    <p class="text-gray-700 leading-relaxed mt-4">
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <p class="text-gray-700">The shooting algorithm is highly efficient and precise when analytical structure is available.</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <p class="text-gray-700">The genetic algorithm provides a flexible, model-agnostic optimization framework.</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <p class="text-gray-700">Despite its stochastic nature, the genetic algorithm converges toward economically meaningful solutions.</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <p class="text-gray-700">Increasing population size, running more generations, or reducing mutation rates would likely improve stability and convergence.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-start gap-3">
                                    ...
                                    <span class="text-gray-700">Translate economic theory into computational solutions</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Implement and compare fundamentally different optimization techniques</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Design fitness functions and convergence criteria</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">Interpret numerical results through an economic lens</span>
                                </div>
                            </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Shooting Algorithm</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Genetic Algorithm</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Economic Modeling</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Numerical Optimization</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Dynamic Programming</span>
                                        <span class="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">Computational Economics</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="flex flex-col md:flex-row items-start justify-between gap-4 mb-6">
                            ...
                            <div class="flex flex-col gap-3 flex-shrink-0 w-full md:w-auto">
                                ...
                                <a href="/Project.ipynb" download class="px-6 py-3 bg-gray-100 hover:bg-gray-200/50 rounded-xl font-medium transition-colors flex items-center gap-2 justify-center">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="bg-gray-100/30 rounded-xl p-5 mt-6">
                                <h3 class="text-lg font-semibold text-indigo-400 mb-3">Pipeline Structure</h3>
                                <p class="text-gray-700 font-mono text-sm">NiFi → MinIO → Spark Notebook</p>
                            </div>
                        </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div class="bg-gray-100/30 rounded-xl p-5">
                                        ...
                                        <p class="text-gray-700 text-sm">Ingests earthquake data in JSON format</p>
                                    </div>
                                    <div class="bg-gray-100/30 rounded-xl p-5">
                                        <h4 class="text-lg font-semibold text-indigo-400 mb-2">CSV Flow</h4>
                                        <p class="text-gray-700 text-sm">Ingests earthquake data in CSV format</p>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-5">
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="bg-gray-100/30 rounded-xl p-5 mb-4">
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    ...
                                    <p class="text-gray-700 text-sm">Most recorded earthquakes have low magnitudes, while high-magnitude events are relatively rare. This becomes clear when aggregating and visualizing magnitude distributions.</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-indigo-400 mb-2">Clear Temporal Patterns Emerge</h3>
                                    <p class="text-gray-700 text-sm">Aggregations over time show that earthquake occurrences are not evenly distributed. Certain periods exhibit clusters of increased activity, highlighting the importance of time-based analysis rather than static summaries.</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-indigo-400 mb-2">Geographical Concentration of Events</h3>
                                    <p class="text-gray-700 text-sm">Grouping events by location reveals that earthquakes are concentrated in specific regions, consistent with known tectonic boundaries. Spark makes it easy to aggregate and compare activity across regions at scale.</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-indigo-400 mb-2">Magnitude vs Frequency Trade-off</h3>
                                    <p class="text-gray-700 text-sm">While smaller earthquakes occur frequently, larger earthquakes contribute disproportionately to overall seismic risk. This contrast is visible when comparing frequency counts with magnitude-weighted summaries.</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-indigo-400 mb-2">Scalability of Analysis</h3>
                                    <p class="text-gray-700 text-sm">Using Spark DataFrames allows these insights to be computed efficiently even as the dataset grows, reinforcing why distributed processing is well-suited for this type of continuously updating data.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-start gap-3">
                                    ...
                                    <span class="text-gray-700">How to ingest live external data</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-indigo-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">How to design clean and reproducible ingestion pipelines</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-indigo-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">How to use object storage as a data lake</span>
                                </div>
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-indigo-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-700">How to extract insights from large datasets using Spark</span>
                                </div>
                            </div>
                            <p class="text-gray-700 leading-relaxed mt-6">
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700">MinIO (S3)</span>
                                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700">Apache Spark</span>
                                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700">Spark DataFrames</span>
                                <span class="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700">Spark SQL</span>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-8 border border-gray-200/50">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    ...
                                    <p class="text-gray-700 text-sm">Import this flow file into NiFi to recreate the JSON ingestion pipeline</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-indigo-400 mb-2">NiFi Flow for CSV Data Ingestion</h3>
                                    <p class="text-gray-700 text-sm">Import this flow file into NiFi to recreate the CSV ingestion pipeline</p>
                                </div>
                                <div class="bg-gray-100/30 rounded-xl p-5">
                                    <h3 class="text-lg font-semibold text-indigo-400 mb-2">Spark Notebook</h3>
                                    <p class="text-gray-700 text-sm">Contains the full analysis with data processing and insights extraction</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-gray-700">2011 Quarterly Labour Force Survey (QLFS)</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">Years of schooling, educational attainment milestones (secondary and higher education), work experience, gender, and regional indicators</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                ...
                                <p class="text-gray-700">4.1% return for each additional year of schooling. Premiums for secondary and higher education are notably higher in London compared to other regions.</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                <h3 class="text-lg font-semibold text-violet-400 mb-2">Regional Disparities</h3>
                                <p class="text-gray-700">Significant regional disparities in returns to education, with London demonstrating higher returns to educational qualifications due to its concentration of high-skilled industries and professional job opportunities.</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                <h3 class="text-lg font-semibold text-violet-400 mb-2">IV Analysis Limitations</h3>
                                <p class="text-gray-700">The instrumental variable approach yielded imprecise estimates due to weak instrument problem (F-statistic of 2.43), highlighting the challenges of identifying robust causal effects in this context.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                ...
                                <div class="text-gray-700">EC4425</div>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                <div class="text-violet-400 font-bold mb-1">Paper</div>
                                <div class="text-gray-700">AER 2022</div>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                <div class="text-violet-400 font-bold mb-1">Sample Size</div>
                                <div class="text-gray-700">~2,000 Android users</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div class="bg-gray-100/30 rounded-xl p-5">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-800">Habit Formation</h3>
                                </div>
                                <p class="text-gray-700 text-sm">Persistent behavioral change resulting from repeated smartphone use</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-5">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-800">Self-Control Problems</h3>
                                </div>
                                <p class="text-gray-700 text-sm">Difficulty aligning actual and ideal usage patterns</p>
                            </div>
                        </div>
                        <p class="text-gray-700 leading-relaxed">
                    ...
                    <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Experimental Design & Identification</h3>
                                    <p class="text-gray-600">Critical assessment of the RCT design and identification strategy</p>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div class="w-8 h-8 bg-violet-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Causal Claims & Balance Assumptions</h3>
                                    <p class="text-gray-600">Evaluation of the validity of causal claims and balance assumptions</p>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div class="w-8 h-8 bg-violet-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Treatment Effects Analysis</h3>
                                    <p class="text-gray-600">Examination of effects on screen time, well-being, and addiction measures</p>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div class="w-8 h-8 bg-violet-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Transparency & Robustness</h3>
                                    <p class="text-gray-600">Assessment of transparency, robustness checks, and deviations from pre-analysis plan</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-6 bg-gray-100/30 rounded-xl p-5">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <h4 class="text-sm font-semibold text-gray-700 mb-2">Internal Validity</h4>
                                ...
                                <div>
                                    <h4 class="text-sm font-semibold text-gray-700 mb-2">External Validity</h4>
                                    <ul class="text-sm text-gray-600 space-y-1">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-100/30 rounded-xl p-5">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-800">Habit Formation Evidence</h3>
                                </div>
                                <p class="text-gray-700">Temporary financial incentives produced persistent reductions in screen time, supporting the habit formation mechanism</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-5">
                                <div class="flex items-center gap-3 mb-3">
                                ...
                                <p class="text-gray-700">App-based limits consistently reduced usage, highlighting ongoing self-control problems among users</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-5">
                                <div class="flex items-center gap-3 mb-3">
                                    <div class="w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-800">Well-Being & Addiction</h3>
                                </div>
                                <p class="text-gray-700">Both interventions reduced self-reported addiction, with modest improvements in subjective well-being</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-5">
                                <div class="flex items-center gap-3 mb-3">
                                    <div class="w-10 h-10 bg-purple-500/20 rounded-lg flex items-center justify-center">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-800">Substitution Patterns</h3>
                                </div>
                                <p class="text-gray-700">Different treatments induced distinct substitution patterns across apps and devices</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-3xl p-8 border border-gray-200/50 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                ...
                                <p class="text-gray-700 text-sm">Using pre-installation smartphone usage data to strengthen baseline comparisons</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                <h3 class="text-sm font-semibold text-violet-400 mb-2">Temporal Validity</h3>
                                <p class="text-gray-700 text-sm">Replicating the experiment outside the COVID-19 period to test temporal generalizability</p>
                            </div>
                            <div class="bg-gray-100/30 rounded-xl p-4">
                                <h3 class="text-sm font-semibold text-violet-400 mb-2">Platform Extension</h3>
                                <p class="text-gray-700 text-sm">Expanding analysis to iOS users to test external validity across platforms</p>
                            </div>
                        </div>
                    </div>
            ...
            if (academicWorks.length === 0) {
                listContainer.innerHTML = `
                    <div class="col-span-full text-center py-12">
                        <p class="text-gray-600">No academic works available yet.</p>
                    </div>
                `;
                return;
            }
            ...
            academicWorks.forEach(work => {
                ...
                workCard.innerHTML = `
                    <div class="p-4 md:p-6 flex flex-col h-full">
                        ...
                        <p class="text-gray-600 mb-4 text-sm md:text-base leading-relaxed flex-grow">${work.description || work.subtitle || ''}</p>
                        <div class="flex flex-wrap gap-2 mb-4">
        ...
        function updateNavButtons() {
            ...
            buttons.forEach(btn => {
                ...
                if (section === activeSection) {
                    ...
                    btn.className = 'nav-pill px-5 py-2 rounded-full text-sm font-medium text-gray-600';
                }
            });
        }
